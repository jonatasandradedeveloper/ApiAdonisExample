# Parecer das prioridades — as duas mentoradas

Pergunta do People Lead: **as prioridades que elas definiram fazem sentido?**
...
Da CALL geral, uma prioridade “boa” neste momento precisa de pelo menos um destes:

1. Atuação visível no projeto (o que o líder e o cliente confirmam).
2. Autoavaliação honesta do que foi combinado no início do FY.
3. Evidência que o People Lead consiga levar para a prática (não só intenção).
4. Sinal de Copilot / IA **aplicada**, compliance, mini CV — o operacional que a prática realmente olha.
...
| Swift | Carreira sim; **ciclo não** | Kotlin/Android agora; sem Mac no histórico; faculdade | Estacionar no plano anual |
| Inglês | **Já entregue (B2→C1+)** | Reabrir “melhorar inglês” esconde a vitória | Registrar como resultado |

**Veredito:** não pedir para ela fazer mais. Pedir para ela **mostrar menos, com evidência**. Associate excelente parece Associate espalhada se o Workday tiver sete parágrafos e zero case.
...
| Pronta para próximo nível? | Não é a tese deste FY | Não é a tese deste FY (cedo), mas o potencial é o mais alto das duas |

## Como conduzir as duas 1:1s de fechamento (mesmo roteiro)

1. **Espelho:** “O que você cadastrou vs. o que o ciclo consegue calibrar.”
2. **Honra o que ela escolheu:** não ridicularizar AI-900 nem Swift.
3. **Recorte:** 3 frentes no Workday.
4. **Evidência:** nomes, casos, revisores.
5. **Expectativa de cargo:** as duas em consolidação, não em campanha de promoção — salvo o projeto surpreender.
6. **Combinado escrito** em `05-acoes.md` no mesmo dia.

Frases prontas estão em cada `02-prioridades.md`.
